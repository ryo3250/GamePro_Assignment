...
[[nodiscard]] bool triangle_polygon::createVertexBuffer() noexcept 
{
...
[[nodiscard]] bool triangle_polygon::createIndexBuffer() noexcept 
{
    ...
    if (FAILED(res)) {
        assert(false && "インデックスバッファのマップの作成に失敗");
        return false;
    }
